...
class MLP(nn.Module):
    """Construct two-layer MLP"""

    def __init__(self, input_dim, hidden_dim, output_dim, skip=False):
        super().__init__()
        self.skip = skip
...
#         else:
#             self.fc = MLP(self._in_src_feats, hidden_dim, out_feats * num_heads)
#             # nn.Linear(
#             #     self._in_src_feats, out_feats * num_heads, bias=False)
